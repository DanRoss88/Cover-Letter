...
<div className="references-container">
  ...
  <div className="references-grid">
    <div className="references-card">
      ...
      <Link href={`mailto:${reference2.email}`}><p>{reference2.email}</p></Link>
      </div>
    <div className="references-card">
      <h2>{reference3.name}</h2>
      <p>{reference3.title}</p>
      <p>{reference3.company}</p>
      <Link href={`mailto:${reference3.email}`}><p>{reference3.email}</p></Link> 
      </div>
    <div className="references-card">
    <h2>{reference1.name}</h2>
      <p>{reference1.title}</p>
      <p>{reference1.company}</p>
    <Link href={`mailto:${reference1.email}`}><p>{reference1.email}</p></Link>
      </div>
      </div>
  </div>
  );
